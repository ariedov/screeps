...
module.exports = {
    ...
    getUpgraders: function() {
        return _.filter(Game.creeps, function(c) { return c.memory.role == 'upgrader'; });
    },

    getRechargers: function() {
        return _.filter(Game.creeps, function(c) { return c.memory.role == 'recharger'; });
    },

    getBuilders: function() {
        return _.filter(Game.creeps, function(c) { return c.memory.role == 'builder'; });
    },

    getWarriors: function() {
        return _.filter(Game.creeps, function(c) { return c.memory.role == 'warrior'; });
    }
};
